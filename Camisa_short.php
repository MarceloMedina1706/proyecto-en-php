...
<body>
	...
	<h1 id="tipo"><?php echo $_GET['tipo']; ?></h1>

	<section id="seccion-cam-short">
		
		<div id="div-cam-short">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if(tipo == "Camisetas"){
			...
			$("#div-cam-short").load("Buscar_Camiseta_short.php", {opc:"Camiseta"});

		}else if(tipo == "Shorts"){

			$("#div-cam-short").load("Buscar_Camiseta_short.php", {opc:"Short"});
