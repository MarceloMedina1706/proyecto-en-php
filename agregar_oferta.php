		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td><input type="number" id="desc" min="1" max="100"></td>
					<td><button id="agregar2" class="btn-modificar-2">Agregar</button></td>
				</tr>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#agregar2").click(function(){
			...
			$.post("agregar_oferta_bdd.php", {id:id, descuento:descuento}, function(data){
